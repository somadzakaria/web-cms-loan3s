        ...
        <div class="card login-card d-flex">
          <div class="row no-gutters">
            ...
            <div class="resend-otp">
              <a href="#" v-on:click.prevent="handleResendOTP($event)">Kirim ulang kode OTP</a>
            </div>
            <div class="container mb-4">
              <button
                  class="btn gm-otp-code-button"
                  type="submit"
              >Verifikasi
              </button>
            </div>
...
export default {
  ...
  computed: {
    ...
    expired() {
      return this.$store.state.auth.user === null ? router.back() : this.$store.state.auth.user.expired_time;
    }
  },
  methods: {
    handleVerify(event) {
